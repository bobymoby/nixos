{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-e51a1a58-a7d8-41b3-821d-f387fb54ed63" =
        [ ];
      "KDE Keyboard Layout Switcher"."Switch to Last-Used Keyboard Layout" =
        "Meta+Alt+L";
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = "Meta+Alt+K";
      "com.google.Chrome"."66542A77822B7AA003837A3AA758A08F-enter-picker-mode" = [ ];
      "com.google.Chrome"."66542A77822B7AA003837A3AA758A08F-enter-zapper-mode" = [ ];
      ...
      "plasmashell"."Slideshow Wallpaper Next Image" = "none,,Next Wallpaper Image";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,10,19,15,17,22.697";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."e51a1a58-a7d8-41b3-821d-f387fb54ed63" =
        "Default";
      "kactivitymanagerdrc"."main"."currentActivity" =
        "e51a1a58-a7d8-41b3-821d-f387fb54ed63";
      ...
      "kwinrc"."Desktops"."Id_1" = "b1da9134-e75e-46ba-85d6-2f43564ea5a7";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/b1da9134-e75e-46ba-85d6-2f43564ea5a7/f5a91959-6944-4ea6-8dfc-8d04adecb3e8"."tiles" =
